...
namespace ProyectoTeorico_TiendaSingapur.Formularios_De_Negocios
{
    public partial class frmCyBEmpleado : Form
    {
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            string consulta = "Select legajo, apellido, nombre, nombreUsuario, contraseña, mail, telefono, id_barrio, calle, nroCalle From Empleado  where legajo = '" + id + "'  and borrado = 0";
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = consulta;
            cn.Open();
            cmd.Connection = cn;
