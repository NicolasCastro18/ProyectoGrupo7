    ...
    public partial class ModificacionEmpleado : Form
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            string consulta = "Update Empleado set nombre = '" + txtNombre.Text + "', apellido = '" + txtApellido.Text + "', nombreUsuario = '" + txtNombreUsuario.Text + "',contraseña = " +
                "'" + txtContraseña.Text + "', mail = '" + txtMail.Text + "',telefono ='" + txtTelefono.Text + "', calle ='" + txtCalle.Text + "',nroCalle = '" + txtAltura.Text + "', id_barrio = '" + cboBarrio.SelectedValue + "' where legajo = '" + Legajo + "'" ;
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = consulta;
            cn.Open();
            cmd.Connection = cn;
